...
**Teach Me** is a tool that builds interactive educational lessons directly from Claude or Codex. Lessons have clear teaching, animated interactions, drills with feedback, optional voice and images, and a closed-book final. You answer a short interview, pick a teaching approach and a look, and get an html lesson that runs in your browser.
...
- **Voice and AI chat**: Want voice narration? What about an in-page chatbot? You can add both (details below)
- **Visuals**: Each lesson has charts and animations, and you can optionally add AI-generated or Wikimedia images
...
Check out [ds-vibe.github.io/teach-me](https://ds-vibe.github.io/teach-me/) for real examples — Law, Business, Art, Music. Try one out.
...
- **Use the checkpoint.** Before building, the skill shows 2–3 looks and approaches. Redirect freely. 
- **Call audibles.** The more context you give, the better the results. Add your own materials or give directions like "go lighter on text," "focus on interactive diagrams" or "tons of drills".
- **Big topics become a series.** A lesson holds at most four objectives. When honest coverage needs more, the skill proposes splitting into multiple lessons.
- **Use the strongest model you have.** Expect best quality with Fable 5 or 5.6 Sol. Other models produce serviceable lessons, but expect flatter prose and occasional errors.
- **Don't wander off mid-build.** In Claude Code or Codex the skill runs real commands that may need your permission — Node scripts, a headless browser, file writes, web lookups. Either keep tabs on the build or auto-approve, otherwise your build may stall.

## Known limitations

- **Pedagogy**: Teach Me is informed by real learning science, but its results haven't been studied (it's brand new). 
...
Lessons keep your quiz results in your browser only (localStorage on your machine). The readout offers your history as a downloadable JSON file. If you add an API key to a lesson, the key and your chat go to the LLM provider. 
...
This skill is intended for making lessons for your own learning. It is not built or intended for commercial use, and generated content may have provider-specific restrictions.

Lessons are study material. Nothing a lesson says is legal, medical, financial, or other professional advice.

## Lineage and credit

Teach Me builds on Derek Schwede's original [html-explainer](https://github.com/ds-vibe/html-explainer) skill. Its pedagogy adapts and extends Rebecca Fordon's [teaching-explainer](https://github.com/rlfordon/teaching-explainer), which itself builds on `html-explainer`. Rebecca Fordon's copyright and MIT notice are in `THIRD-PARTY-NOTICES.md`.
