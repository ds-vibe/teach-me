...
(function () {
  ...
  var css = [
    ...
    "#ad-panel{position:fixed;bottom:20px;right:20px;z-index:72;width:384px;max-width:calc(100vw - 32px);max-height:calc(100vh - 40px);background:var(--card,var(--surface,#fff));color:var(--ink,var(--fg,#181818));border:1px solid var(--line-strong,var(--line2,#cfcfcf));border-radius:16px;box-shadow:0 24px 70px rgba(0,0,0,.35);display:flex;flex-direction:column;overflow:hidden;font-family:var(--sans,system-ui,sans-serif)}",
    ".ad-head{display:flex;align-items:center;gap:10px;padding:13px 16px;border-bottom:1px solid var(--line,#e3e3e3)}",
    ".ad-head h3{font-size:14.5px;margin:0}.ad-head .x{margin-left:auto;background:none;border:none;font-size:22px;line-height:1;color:var(--ink-soft,var(--fg2,#666));cursor:pointer}",
    ".ad-key{padding:11px 15px;border-bottom:1px solid var(--line,#e3e3e3)}",
    ".ad-key input{width:100%;font-family:var(--mono,monospace);font-size:12.5px;border:1px solid var(--line-strong,var(--line2,#cfcfcf));border-radius:9px;padding:8px 11px;box-sizing:border-box;background:var(--bg,#fff);color:var(--ink,var(--fg,#181818))}",
    ".ad-key .note{font-size:11px;color:var(--ink-faint,var(--muted,#8a8a8a));margin-top:6px;line-height:1.45}",
    ".ad-tabs{display:flex;border-bottom:1px solid var(--line,#e3e3e3)}",
    ".ad-tab{flex:1;background:none;border:none;padding:10px;font-family:inherit;font-size:13px;font-weight:600;color:var(--ink-soft,var(--fg2,#666));cursor:pointer;border-bottom:2px solid transparent}",
    ".ad-tab.on{color:var(--ink,var(--fg,#181818));border-bottom-color:" + ACCENT + "}",
    ".ad-body{padding:15px;overflow:auto;flex:1}",
    ".ad-body p{margin:0 0 10px;font-size:13.5px;line-height:1.5;color:var(--ink-soft,var(--fg2,#555))}",
    ...
    ".ad-msg.u{align-self:flex-end;background:var(--accent-soft,var(--good-soft,rgba(127,127,127,.14)))}",
    ".ad-msg.a{align-self:flex-start;background:var(--panel,var(--surface2,rgba(127,127,127,.08)));border:1px solid var(--line,#e3e3e3)}",
    ".ad-msg.sys{align-self:center;font-size:11.5px;color:var(--ink-faint,var(--muted,#8a8a8a));font-family:var(--mono,monospace);text-align:center}",
    ".ad-ask{display:flex;gap:8px;margin-top:10px}",
    ".ad-ask input{flex:1;font-size:13.5px;padding:9px 11px;border:1px solid var(--line-strong,var(--line2,#cfcfcf));border-radius:9px;background:var(--bg,#fff);color:var(--ink,var(--fg,#181818))}",
